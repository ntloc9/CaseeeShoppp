...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post cases_url, params: { case: { brand: @case.brand, model: @case.model, price: @case.price, title: @case.title } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { brand: @case.brand, model: @case.model, price: @case.price, title: @case.title } }
